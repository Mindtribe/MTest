...
if ps.communicationProtocol == 'serial':
	try:
		...
		raise Exception('This error should be expected during the minimum serial timeout test (likely due to the timeout being too short). Minimum serial timeout is %s seconds. Set serialTimeout parameter in AgilentE3633A.json to this value to increase programming speed.' % minTimeout)

	print 'Minimum serial timeout is %f seconds. Set serialTimeout parameter in AgilentE3633A.json to this value to increase programming speed.' % minTimeout
